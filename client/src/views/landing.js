...
function Landing() {
  ...
  return (
    <div className='flex justify-center w-screen bg-gray-theme text-dark-theme'>
      <div className='block w-[80vw] h-screen'>
        ...
        <div className='flex flex-wrap justify-center items-center w-full text-[50px]'>
          ...
          <div className='w-full mt-[2vh] text-gray-500 text-center text-lg font-light'>
          ...
          <div className='w-[full] mt-[5vh]'>
            <div className='flex justify-evenly w-[40vw]'>
              <Link to='/signup' className='flex justify-center items-center w-[200px] h-[45px] text-lg text-white font-semibold border border-dark-accent rounded-xl bg-dark-accent'>Get Started</Link>
              <Link to='/signup' className='flex justify-center items-center w-[200px] h-[45px] text-lg font-semibold border-2 border-dark-accent rounded-xl'>Features</Link>
            </div>
          </div>
        </div>
      </div>
